...
<qgis version="2.18.1" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="aanduiding">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="bestemmingsvlak">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@0@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="101,18,184,201"/>
  ...
  <aliases>
    ...
    <alias field="aanduiding" index="1" name=""/>
    <alias field="bestemmingsvlak" index="2" name=""/>
    <alias field="historisch" index="3" name=""/>
    <alias field="identificatie" index="4" name=""/>
    <alias field="naam" index="5" name=""/>
    <alias field="plangebied" index="6" name=""/>
    <alias field="planstatus" index="7" name=""/>
    <alias field="typePlan" index="8" name=""/>
    <alias field="versieIMRO" index="9" name=""/>
    <alias field="verwijzingNaarObjectgerichteTekst" index="10" name=""/>
    <alias field="dossierID" index="11" name=""/>
    <alias field="dossierStatus" index="12" name=""/>
    <alias field="verwijzingNaarTekst" index="13" name=""/>
    <alias field="datum" index="14" name=""/>
    <alias field="verwijzingNaarExternPlan" index="15" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="911000080">
    <columns>
