...
<qgis hasScaleBasedVisibilityFlag="0" version="3.10.0-A Coruña" styleCategories="AllStyleCategories" maxScale="-4.65661e-10" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="0" readOnly="0" minScale="1e+8" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1">
  <flags>
  ...
  <aliases>
    ...
    <alias field="plangebied" name="" index="6"/>
    <alias field="planstatus" name="" index="7"/>
    <alias field="typePlan" name="" index="8"/>
    <alias field="versieIMRO" name="" index="9"/>
    <alias field="verwijzingNaarObjectgerichteTekst" name="" index="10"/>
    <alias field="dossierID" name="" index="11"/>
    <alias field="dossierStatus" name="" index="12"/>
    <alias field="verwijzingNaarTekst" name="" index="13"/>
    <alias field="datum" name="" index="14"/>
    <alias field="verwijzingNaarExternPlan" name="" index="15"/>
  </aliases>
  ...
  <attributeactions>
    ...
    <actionsetting icon="" capture="0" type="1" id="{6cd2a543-3afb-4644-8608-11231a6b821e}" notificationMessage="" isEnabledOnlyWhenEditable="0" shortTitle="" name="Open text link(s) in browser " action="&#xa;from qgis.core import QgsMessageLog&#xa;from qgis.PyQt.QtGui import QDesktopServices&#xa;from qgis.PyQt.QtCore import QUrl&#xa;&#xa;urls = &quot;&quot;&#xa;if &quot;[%verwijzingNaarTekst%]&quot;:&#xa;    urls = &quot;[%verwijzingNaarTekst%]&quot;&#xa;elif &quot;[%verwijzingNaarObjectgerichteTekst%]&quot;:&#xa;    urls = &quot;[%verwijzingNaarObjectgerichteTekst%]&quot;&#xa;&#xa;for url in urls.split(','):&#xa;    QDesktopServices().openUrl(QUrl(url))&#xa;">
