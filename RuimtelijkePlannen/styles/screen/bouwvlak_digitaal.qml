...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+8" styleCategories="AllStyleCategories" simplifyDrawingHints="1" readOnly="0" simplifyMaxScale="1" simplifyAlgorithm="0" version="3.10.0-A Coruña" simplifyDrawingTol="1" simplifyLocal="1" labelsEnabled="0">
  <flags>
  ...
  <aliases>
    ...
    <alias field="bestemmingsvlak" name="" index="1"/>
    <alias field="historisch" name="" index="2"/>
    <alias field="identificatie" name="" index="3"/>
    <alias field="naam" name="" index="4"/>
    <alias field="plangebied" name="" index="5"/>
    <alias field="planstatus" name="" index="6"/>
    <alias field="typePlan" name="" index="7"/>
    <alias field="versieIMRO" name="" index="8"/>
    <alias field="verwijzingNaarObjectgerichteTekst" name="" index="9"/>
    <alias field="dossierID" name="" index="10"/>
    <alias field="dossierStatus" name="" index="11"/>
    <alias field="datum" name="" index="12"/>
    <alias field="verwijzingNaarExternPlan" name="" index="13"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint field="bestemmingsvlak" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="bestemmingsvlak" exp="" desc=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" name="bestemmingsvlak" hidden="0" width="-1"/>
