...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="gebiedsaanduidinggroep = 'geluidzone'" symbol="0" label="geluidzone"/>
      <rule filter="gebiedsaanduidinggroep = 'luchtvaartverkeerzone'" symbol="1" label="luchtvaartverkeerzone"/>
      <rule filter="gebiedsaanduidinggroep = 'milieuzone'" symbol="2" label="milieuzone"/>
      <rule filter="gebiedsaanduidinggroep = 'reconstructiewetzone'" symbol="3" label="reconstructiewetzone"/>
      <rule filter="gebiedsaanduidinggroep = 'veiligheidszone'" symbol="4" label="veiligheidszone"/>
      <rule filter="gebiedsaanduidinggroep = 'vrijwaringszone'" symbol="5" label="vrijwaringszone"/>
      <rule filter="gebiedsaanduidinggroep = 'wro-zone'" symbol="6" label="wro-zone"/>
      <rule filter="gebiedsaanduidinggroep = 'overig'" symbol="7" label="overig"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@0@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,155,0,255"/>
              <prop k="color_border" v="255,155,0,255"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@1@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="155,50,205,255"/>
              <prop k="color_border" v="155,50,205,255"/>
              <prop k="name" v="triangle"/>
              <prop k="offset" v="2,-2"/>
              <prop k="scale_method" v="area"/>
              <prop k="size" v="5"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@2@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,155,0,255"/>
              <prop k="color_border" v="0,155,0,255"/>
              <prop k="name" v="triangle"/>
              <prop k="offset" v="2,-2"/>
              <prop k="scale_method" v="area"/>
              <prop k="size" v="5"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@3@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="56,133,94,255"/>
              <prop k="color_border" v="56,133,94,255"/>
              <prop k="name" v="triangle"/>
              <prop k="offset" v="2,-2"/>
              <prop k="scale_method" v="area"/>
              <prop k="size" v="5"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@5@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="55,205,0,255"/>
              <prop k="color_border" v="55,205,0,255"/>
              <prop k="name" v="triangle"/>
              <prop k="offset" v="2,-2"/>
              <prop k="scale_method" v="area"/>
              <prop k="size" v="5"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol outputUnit="MM" alpha="1" type="marker" name="@7@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="100,100,100,255"/>
              <prop k="color_border" v="100,100,100,255"/>
              <prop k="name" v="triangle"/>
              <prop k="offset" v="2,-2"/>
              <prop k="scale_method" v="area"/>
              <prop k="size" v="5"/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="gebiedsaanduidinggroep"/>
