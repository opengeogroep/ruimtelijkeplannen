...
<qgis version="2.18.1" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="bestemmingsvlak" index="1" name=""/>
    <alias field="historisch" index="2" name=""/>
    <alias field="identificatie" index="3" name=""/>
    <alias field="naam" index="4" name=""/>
    <alias field="plangebied" index="5" name=""/>
    <alias field="planstatus" index="6" name=""/>
    <alias field="typePlan" index="7" name=""/>
    <alias field="versieIMRO" index="8" name=""/>
    <alias field="verwijzingNaarObjectgerichteTekst" index="9" name=""/>
    <alias field="dossierID" index="10" name=""/>
    <alias field="dossierStatus" index="11" name=""/>
    <alias field="datum" index="12" name=""/>
    <alias field="verwijzingNaarExternPlan" index="13" name=""/>
  </aliases>
