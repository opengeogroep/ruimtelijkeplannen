...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="substr(replace(replace( waarde,')',''),'(',''),strpos(replace(replace( waarde,')',''),'(',''),':') + 2,length(replace(replace( waarde,')',''),'(',''))) || ' m.'"/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="maatvoeringInfo|WaardeEnType|symboolCode"/>
    <edittype type="0" name="naam"/>
    <edittype type="0" name="namespace"/>
    <edittype type="0" name="symboolCode"/>
    <edittype type="0" name="typePlanobject"/>
    <edittype type="0" name="waarde"/>
    <edittype type="0" name="waardeType"/>
  </edittypes>
  <editform></editform>
