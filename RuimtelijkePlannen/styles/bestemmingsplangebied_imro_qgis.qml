...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype type="0" name="beleidsmatigVerantwoordelijkeOverheid"/>
    <edittype type="0" name="datum"/>
    <edittype type="0" name="gml_id"/>
    <edittype type="0" name="locatieNaam"/>
    <edittype type="0" name="lokaalID"/>
    <edittype type="0" name="naam"/>
    <edittype type="0" name="naamOverheid"/>
    <edittype type="0" name="namespace"/>
    <edittype type="0" name="ondergronddatum"/>
    <edittype type="0" name="ondergrondtype"/>
    <edittype type="0" name="overheidsCode"/>
    <edittype type="0" name="planstatus"/>
    <edittype type="0" name="typePlan"/>
    <edittype type="0" name="typeTekst"/>
    <edittype type="0" name="versie"/>
    <edittype type="0" name="verwijzingNaarTekst"/>
    <edittype type="0" name="verwijzingNorm"/>
  </edittypes>
  <editform></editform>
